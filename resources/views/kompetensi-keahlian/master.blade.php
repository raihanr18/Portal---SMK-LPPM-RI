    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="/guru-staff">Guru dan Staff</a></li>
          <li class="drop-down"><a href="">Pembelajaran</a>
            <ul>
              <li><a href="http://e-learning.smktarpan1.sch.id/" target="_blank">E-Learning</a></li>
              ...
              <li><a href="" target="_blank">E-Raport</a></li>
            </ul>
          </li>
  ...
  <section id="hero" class="d-flex align-items-center">
   ...
   <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              <br>
              <strong>Phone:</strong> +62 5589 55488 55 (CS)<br>
              <strong>Email:</strong> smklppmri@gmail.com<br>
            </p>
          </div>
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>SMK LPPM RI</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Designed by <a href="#">Team SMK LPPM RI</a>
      </div>
    </div>
  </footer><!-- End Footer -->
